...
export default function Header() {
    ...
    return (
        <motion.header
            ...
            className="fixed top-0 left-0 w-full z-50 px-6 py-6 flex justify-between items-center mix-blend-exclusion text-white"
        >
            <nav className="flex items-center gap-8 font-medium text-sm md:text-base tracking-widest uppercase">

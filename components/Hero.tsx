...
export default function Hero() {
    ...
    return (
        <section id="about" className="h-screen w-full flex flex-col items-center justify-center relative overflow-hidden">
            ...
            >
                <h1 className="text-5xl md:text-8xl font-display tracking-widest text-white mb-6 uppercase">
                    Heaven Filmes
                </h1>
                <p className="text-xl md:text-2xl text-white font-light tracking-[0.5em] uppercase pl-2">
                    {t.hero.role}
                </p>
            </motion.div>
